...
ADMINS = (
     ('admin', 'dima.chuvardinsky@gmail.com'),
)
...
SECRET_KEY = '51yr++pw0uo73y2x*&tvn#qcgqdyj260(^t4$j1i2iczko4&=8'
...
MIDDLEWARE_CLASSES = (
    ...
    'testing.middleware.HttpRequestDbLoggingMiddleware',
)
